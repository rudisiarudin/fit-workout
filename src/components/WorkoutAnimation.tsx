...
export default function WorkoutAnimation({ src, workoutName }: WorkoutAnimationProps) {
  ...
  return (
    <div className="w-full max-w-xl mx-auto rounded-3xl bg-[#f5f5f5] border border-zinc-100 dark:border-zinc-800 shadow-xl shadow-zinc-150/10 p-6 relative overflow-hidden flex flex-col items-center justify-center min-h-[400px]">
      ...
      {isPlaceholder || hasError ? (
        <div className="flex flex-col items-center justify-center p-6 text-center animate-pulse-slow">
          <div className="w-24 h-24 rounded-full bg-brand-100 flex items-center justify-center mb-4 text-brand-500 border border-brand-200">
            <Dumbbell className="h-12 w-12 animate-bounce" />
          </div>
          <h4 className="text-xl font-black text-zinc-800 mb-1">{workoutName}</h4>
          <span className="text-xs text-brand-500 font-semibold tracking-wider uppercase mb-3 flex items-center gap-1.5 justify-center">
          ...
          <div className="mt-6 w-full max-w-[240px] aspect-video rounded-2xl bg-[#f5f5f5] border border-zinc-200/50 flex items-center justify-center overflow-hidden">
        ...
        <div className="w-full relative min-h-[380px] flex items-center justify-center overflow-hidden">
          {loading && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#f5f5f5] z-10">
