...
export default function WorkoutAnimation({ src, workoutName }: WorkoutAnimationProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto rounded-3xl bg-white dark:bg-zinc-900/60 border border-zinc-100 dark:border-zinc-800/80 shadow-xl shadow-zinc-150/10 dark:shadow-none p-5 relative overflow-hidden flex flex-col items-center justify-center min-h-[300px]">
      ...
      {isPlaceholder || hasError ? (
        <div className="flex flex-col items-center justify-center p-6 text-center animate-pulse-slow">
          <div className="w-20 h-20 rounded-full bg-brand-100 dark:bg-brand-950/50 flex items-center justify-center mb-4 text-brand-500 border border-brand-200 dark:border-brand-900/50">
            <Dumbbell className="h-10 w-10 animate-bounce" />
          </div>
          <h4 className="text-lg font-bold text-zinc-800 dark:text-zinc-200 mb-1">{workoutName}</h4>
          ...
          <div className="mt-6 w-full max-w-[200px] aspect-video rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/50 dark:border-zinc-800/50 flex items-center justify-center overflow-hidden">
            <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-brand-500">
