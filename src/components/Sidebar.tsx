...
export default function Sidebar({ currentView, setView }: SidebarProps) {
  ...
  return (
    <aside className="hidden md:flex flex-col w-72 h-screen fixed left-0 top-0 border-r border-zinc-200/50 dark:border-zinc-800/80 bg-white dark:bg-zinc-950 px-5 py-6 z-40 select-none">
      ...
      <div className="mt-auto border-t border-zinc-100 dark:border-zinc-800/80 pt-4 space-y-4">
        ...
        <div className="bg-gradient-to-br from-brand-500/5 to-orange-500/5 dark:from-brand-950/20 dark:to-zinc-950/40 border border-brand-100/30 dark:border-brand-900/20 p-3.5 rounded-2xl flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs font-extrabold text-zinc-700 dark:text-zinc-250 mt-1 block">Workout Streak: 3 Hari</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="text-xs font-black text-zinc-700 dark:text-zinc-250 block">Fit User</span>
              <span className="text-[9px] text-zinc-400 font-semibold block mt-0.5">Premium Athlete</span>
            </div>
          </div>
          <ThemeToggle />
        </div>
